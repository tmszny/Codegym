...
public class Solution {
    ...
    public static class Cialo {
        public static void obliczBMI(double waga, double wzrost) {
            ...
            if(BMI < 18.5) System.out.println("Niedowaga: BMI < 18.5");
            else if(BMI >= 18.5 && BMI < 25) System.out.println("Norma: 18.5 <= BMI < 25");
            else if(BMI >= 25 && BMI < 30) System.out.println("Nadwaga: 25 <= BMI < 30");
            else System.out.println("Otyłość: BMI >= 30");
        }
    }
}
